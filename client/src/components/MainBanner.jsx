    ...
    return (
        <div className="relative">
            ...
            md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
                ...
                max-w-72 md:max-w-80 lg:maz-w-105 leading-tight lg:leading-15'
                >Freshness You Can Trust, Savings You will Love!</h1>
            
            <div className='flex items-center  font-medium mt-12'>
                ...
                cursor-pointer'>
                Explore deals
                <img className='transition group-hpver:translate-x-1' src = {assets.black_arrow_icon} alt = "arrow"/>
                </Link>
            </div>
            </div>
        </div>
